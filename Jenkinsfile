  ...
  stages {
   ...
   stage('Cloning Git') {
    ...
    stage('Testing Project') {
      steps {
        bat 'dotnet test "C://Windows//SysWOW64//config//systemprofile//AppData//Local//Jenkins.jenkins//workspace//$env.Envronmentbackend-marketing-place//basecs.tests//basecs.tests.csproj" '
      }
    }
