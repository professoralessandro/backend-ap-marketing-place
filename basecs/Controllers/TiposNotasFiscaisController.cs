...
{
    public class TiposNotasFiscaisController : ControllerCS
    {
        #region ATRIBUTTES
        private readonly TiposNotasFiscaisService _service;
        private readonly LogsService _log;
        #endregion

        #region CONSTRUCTORS
        public TiposNotasFiscaisController([FromServices] TiposNotasFiscaisService service, [FromServices] LogsService log)
        {
            _service = service;
            _log = log;
        }
        ...
        public async Task<ActionResult<List<TipoNotaFiscal>>> ReturnListWithParameters(
                [FromQuery] int? id,
        ...
        #region INSERT
        [HttpPost]
        public async Task<ActionResult<TipoNotaFiscal>> Insert([FromBody] TipoNotaFiscal model)
        {
            try
            {
        ...
        #region UPDATE
        [HttpPut]
        public async Task<ActionResult<TipoNotaFiscal>> Update(TipoNotaFiscal model)
        {
            try
            {
