...
{
    public class StatusEnviosController : ControllerCS
    {
        #region ATRIBUTTES
        private readonly StatusEnviosService _service;
        private readonly LogsService _log;
        #endregion

        #region CONSTRUCTORS
        public StatusEnviosController([FromServices] StatusEnviosService service, [FromServices] LogsService log)
        {
            _service = service;
            _log = log;
        }
        ...
        public async Task<ActionResult<List<StatusEnvio>>> ReturnListWithParameters(
                [FromQuery] int? id,
        ...
        #region INSERT
        [HttpPost]
        public async Task<ActionResult<StatusEnvio>> Insert([FromBody] StatusEnvio model)
        {
            try
            {
        ...
        #region UPDATE
        [HttpPut]
        public async Task<ActionResult<StatusEnvio>> Update(StatusEnvio model)
        {
            try
            {
