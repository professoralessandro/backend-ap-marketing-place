...
namespace backend_adm.Controllers
{
    public class ConfiguracoesParametrosController : ControllerCS
    {
        ...
        public async Task<ActionResult<List<ConfiguracaoParametro>>> ReturnListWithParameters(
                [FromQuery] int? id,
        ...
        #region INSERT
        [HttpPost]
        public async Task<ActionResult<ConfiguracaoParametro>> Insert([FromBody] ConfiguracaoParametro model)
        {
            try
            {
        ...
        #region UPDATE
        [HttpPut]
        public async Task<ActionResult<ConfiguracaoParametro>> Update(ConfiguracaoParametro model)
        {
            try
            {
