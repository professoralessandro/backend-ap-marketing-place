...
{
    public class TiposCaracteristicasController : ControllerCS
    {
        #region ATRIBUTTES
        private readonly TiposCaracteristicasService _service;
        private readonly LogsService _log;
        #endregion

        #region CONSTRUCTORS
        public TiposCaracteristicasController([FromServices] TiposCaracteristicasService service, [FromServices] LogsService log)
        {
            _service = service;
            _log = log;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<List<TipoCaracteristica>>> ReturnListWithParameters(
            [FromQuery] int? id,
            [FromQuery] string descricao,
            [FromQuery] bool? ativo
            )
        ...
        #region INSERT
        [HttpPost]
        public async Task<ActionResult<TipoCaracteristica>> Insert([FromBody] TipoCaracteristica model)
        {
            try
            {
        ...
        #region UPDATE
        [HttpPut]
        public async Task<ActionResult<TipoCaracteristica>> Update(TipoCaracteristica model)
        {
            try
            {
