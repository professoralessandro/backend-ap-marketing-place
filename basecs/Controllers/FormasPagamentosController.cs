...
{
    public class FormasPagamentosController : ControllerCS
    {
        #region ATRIBUTTES
        private readonly FormasPagamentosService _service;
        private readonly LogsService _log;
        #endregion

        #region CONSTRUCTORS
        public FormasPagamentosController([FromServices] FormasPagamentosService service, [FromServices] LogsService log)
        {
            _service = service;
            _log = log;
        }
        ...
        public async Task<ActionResult<List<FormaPagamento>>> ReturnListWithParameters(
                [FromQuery] int? id,
        ...
        #region INSERT
        [HttpPost]
        public async Task<ActionResult<FormaPagamento>> Insert([FromBody] FormaPagamento model)
        {
            try
            {
        ...
        #region UPDATE
        [HttpPut]
        public async Task<ActionResult<FormaPagamento>> Update(FormaPagamento model)
        {
            try
            {
