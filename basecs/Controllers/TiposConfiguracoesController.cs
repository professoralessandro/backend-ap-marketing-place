...
{
    public class TiposConfiguracoesController : ControllerCS
    {
        #region ATRIBUTTES
        private readonly TiposConfiguracoesService _service;
        private readonly LogsService _log;
        #endregion

        #region CONSTRUCTORS
        public TiposConfiguracoesController([FromServices] TiposConfiguracoesService service, [FromServices] LogsService log)
        {
            _service = service;
            _log = log;
        }
        ...
        #region INSERT
        [HttpPost]
        public async Task<ActionResult<TipoConfiguracao>> Insert([FromBody] TipoConfiguracao model)
        {
            try
            {
        ...
        #region UPDATE
        [HttpPut]
        public async Task<ActionResult<TipoConfiguracao>> Update(TipoConfiguracao model)
        {
            try
            {
