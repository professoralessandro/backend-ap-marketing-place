...
{
    public class TiposProdutosController : ControllerCS
    {
        #region ATRIBUTTES
        private readonly TiposProdutosService _service;
        private readonly LogsService _log;
        #endregion

        #region CONSTRUCTORS
        public TiposProdutosController([FromServices] TiposProdutosService service, [FromServices] LogsService log)
        {
            _service = service;
            _log = log;
        }
        ...
        public async Task<ActionResult<List<TipoProduto>>> ReturnListWithParameters(
                [FromQuery] int? id,
        ...
        #region INSERT
        [HttpPost]
        public async Task<ActionResult<TipoProduto>> Insert([FromBody] TipoProduto model)
        {
            try
            {
        ...
        #region UPDATE
        [HttpPut]
        public async Task<ActionResult<TipoProduto>> Update(TipoProduto model)
        {
            try
            {
