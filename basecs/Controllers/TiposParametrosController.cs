...
{
    public class TiposParametrosController : ControllerCS
    {
        #region ATRIBUTTES
        private readonly TiposParametrosService _service;
        private readonly LogsService _log;
        #endregion

        #region CONSTRUCTORS
        public TiposParametrosController([FromServices] TiposParametrosService service, [FromServices] LogsService log)
        {
            _service = service;
            _log = log;
        }
        ...
        public async Task<ActionResult<List<TipoParametro>>> ReturnListWithParameters(
                [FromQuery] int? id,
        ...
        #region INSERT
        [HttpPost]
        public async Task<ActionResult<TipoParametro>> Insert([FromBody] TipoParametro model)
        {
            try
            {
        ...
        #region UPDATE
        [HttpPut]
        public async Task<ActionResult<TipoParametro>> Update(TipoParametro model)
        {
            try
            {
