...
{
    public class TiposTelefonesController : ControllerCS
    {
        #region ATRIBUTTES
        private readonly TiposTelefonesService _service;
        private readonly LogsService _log;
        #endregion

        #region CONSTRUCTORS
        public TiposTelefonesController([FromServices] TiposTelefonesService service, [FromServices] LogsService log)
        {
            _service = service;
            _log = log;
        }
        ...
        public async Task<ActionResult<List<TipoTelefone>>> ReturnListWithParameters(
                [FromQuery] int? id,
        ...
        #region INSERT
        [HttpPost]
        public async Task<ActionResult<TipoTelefone>> Insert([FromBody] TipoTelefone model)
        {
            try
            {
        ...
        #region UPDATE
        [HttpPut]
        public async Task<ActionResult<TipoTelefone>> Update(TipoTelefone model)
        {
            try
            {
