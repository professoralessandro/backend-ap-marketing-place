...
{
    public class TiposLancamentosController : ControllerCS
    {
        #region ATRIBUTTES
        private readonly TiposLancamentosService _service;
        private readonly LogsService _log;
        #endregion

        #region CONSTRUCTORS
        public TiposLancamentosController([FromServices] TiposLancamentosService service, [FromServices] LogsService log)
        {
            _service = service;
            _log = log;
        }
        ...
        public async Task<ActionResult<List<TipoLancamento>>> ReturnListWithParameters(
                [FromQuery] int? id,
        ...
        #region INSERT
        [HttpPost]
        public async Task<ActionResult<TipoLancamento>> Insert([FromBody] TipoLancamento model)
        {
            try
            {
        ...
        #region UPDATE
        [HttpPut]
        public async Task<ActionResult<TipoLancamento>> Update(TipoLancamento model)
        {
            try
            {
