...
namespace basecs.Repository
{
    public class ComprasRepository : IComprasRepository
    {
        ...
        public ComprasRepository(APDConnector session)
        {
            _session = session;
        }
        ...
        public async Task<int> InsertUserAsync(InsertCompraDto model)
        {
            var Params = new {
            ...
            query = @"
                INSERT INTO [seg].[Compras]([Usuario], [NmrDocumento], [TipoDocumento], [Senha], [Nome], [DataNascimento], [Sexo], [EstadoCivil], [Email], [TrocaSenha], [Bloqueado], [UsuarioInclusaoId], [UsuarioUltimaAlteracaoId], [DataInclusao], [DataUltimaAlteracao], [DataUltimaTrocaSenha], [DataUltimoLogin], [Ativo])
        ...
        public async Task<int> UpdateValidation(EditCompraDto model)
        {
            var Params = new
            {
                Id = model.Id,
