...
namespace basecs.tests.Services.Enderecos
{
    public class EnderecosServiceTest
    {
        ...
        {
            var retorno = new basecs.Models.Endereco { EnderecoId = 1, Logradouro = "Unit Test", PontoReferencia = "", Complemento = "CASA", Bairro = "Unit Test", Cidade = "Sao Paulo", Cep = "123456", Estado = "SP", TipoEnderecoId = 1, Numero = "10", IsPrincipal = true, Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now };
        ...
        {
            await Assert.ThrowsAsync<Exception>(() => _service.Insert(new basecs.Models.Endereco { EnderecoId = 200, Logradouro = "Unit Test", PontoReferencia = "", Complemento = "CASA", Bairro = "Unit Test", Cidade = "Sao Paulo", Cep = "123456", Estado = "SP", TipoEnderecoId = 1, Numero = "10", IsPrincipal = true, Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now }));
        }

        [Fact(DisplayName = "Insert Send Invalid Post Description")]
        public async Task Insert_SendInvalidPostDescription()
        {
            await Assert.ThrowsAsync<Exception>(() => _service.Insert(new basecs.Models.Endereco { EnderecoId = 0, Logradouro = "D", PontoReferencia = "", Complemento = "CASA", Bairro = "Unit Test", Cidade = "Sao Paulo", Cep = "123456", Estado = "SP", TipoEnderecoId = 1, Numero = "10", IsPrincipal = true, Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now }));
        }
        #endregion
        ...
        {
            var retorno = new basecs.Models.Endereco { EnderecoId = 200, Logradouro = "Unit Test", Complemento = "CASA", PontoReferencia = "", Bairro = "Unit Test", Cidade = "Sao Paulo", Cep = "123456", Estado = "SP", TipoEnderecoId = 1, Numero = "10", IsPrincipal = true, Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now };
        ...
        {
            await Assert.ThrowsAsync<Exception>(() => _service.Update(new basecs.Models.Endereco { EnderecoId = 0, Logradouro = "Unit Test", PontoReferencia = "", Complemento = "CASA", Bairro = "Unit Test", Cidade = "Sao Paulo", Cep = "123456", Estado = "SP", TipoEnderecoId = 1, Numero = "10", IsPrincipal = true, Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now }));
        }

        [Fact]
        public async Task Update_SendInvalidPostDescription()
        {
            await Assert.ThrowsAsync<Exception>(() => _service.Update(new basecs.Models.Endereco { EnderecoId = 6, Logradouro = "D", PontoReferencia = "", Complemento = "CASA", Bairro = "Unit Test", Cidade = "Sao Paulo", Cep = "123456", Estado = "SP", TipoEnderecoId = 1, Numero = "10", IsPrincipal = true, Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now }));
        }
        #endregion
