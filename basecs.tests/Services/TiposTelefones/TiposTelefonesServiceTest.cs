...
{
    public class TiposTelefoneServiceTest
    {
        #region ATRIBUTTES
        ...
        #region CONSTRUCTORS
        public TiposTelefoneServiceTest()
        {
        ...
        {
            var retorno = new basecs.Models.TipoTelefone { TipoTelefoneId = 1, Descricao = "Unit Test", Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now };
        ...
        {
            await Assert.ThrowsAsync<Exception>(() => _service.Insert(new basecs.Models.TipoTelefone { TipoTelefoneId = 200, Descricao = "Unit Test", Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now }));
        }
        ...
        {
            var retorno = new basecs.Models.TipoTelefone { TipoTelefoneId = 200, Descricao = "Unit Test", Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now };
        ...
        {
            await Assert.ThrowsAsync<Exception>(() => _service.Update(new basecs.Models.TipoTelefone { TipoTelefoneId = 0, Descricao = "Unit Test", Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now }));
        }
