...
namespace basecs.tests.Services.TipoDocumento
{
    public class TipoDocumentoServiceTest
    {
        ...
        {
            var retorno = new basecs.Models.TipoDocumento { TipoDocumentoId = 1, Descricao = "Unit Test", Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now };
        ...
        {
            await Assert.ThrowsAsync<Exception>(() => _service.Insert(new basecs.Models.TipoDocumento { TipoDocumentoId = 200, Descricao = "Unit Test", Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now }));
        }
        ...
        {
            var retorno = new basecs.Models.TipoDocumento { TipoDocumentoId = 200, Descricao = "Unit Test", Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now };
        ...
        {
            await Assert.ThrowsAsync<Exception>(() => _service.Update(new basecs.Models.TipoDocumento { TipoDocumentoId = 0, Descricao = "Unit Test", Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now }));
        }
