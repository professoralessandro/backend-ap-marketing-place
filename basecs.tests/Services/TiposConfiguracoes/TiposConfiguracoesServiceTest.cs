...
namespace basecs.tests.Services.TipoConfiguracao
{
    public class TipoConfiguracaoServiceTest
    {
        ...
        {
            var retorno = new basecs.Models.TipoConfiguracao { TipoConfiguracaoId = 1, Descricao = "Descricao Teste", Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now };
        ...
        {
            await Assert.ThrowsAsync<Exception>(() => _service.Insert(new basecs.Models.TipoConfiguracao { TipoConfiguracaoId = 200, Descricao = "Descricao Teste", Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now }));
        }
        ...
        {
            var retorno = new basecs.Models.TipoConfiguracao { TipoConfiguracaoId = 200, Descricao = "Descricao Teste", Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now };
        ...
        {
            await Assert.ThrowsAsync<Exception>(() => _service.Update(new basecs.Models.TipoConfiguracao { TipoConfiguracaoId = 0, Descricao = "Descricao Teste", Ativo = true, UsuarioUltimaAlteracaoId = 1, UsuarioInclusaoId = 1, DataInclusao = DateTime.Now, DataUltimaAlteracao = DateTime.Now }));
        }
